...
/*
Mini-language:
  //== This is a normal heading, which starts a department. Sections group variables together.
  ...
  //-- This is a heading for a department whose variables shouldn't be customizable
  ...
  while (true) {
    ...
    if (section === null) {
      if (this._tokenizer.shift() !== null) {
        throw new Error('Unexpected unparsed department of file remains!');
      }
      return sections;
    }
...
Parser.prototype.parseSection = function () {
  ...
  if (!(section instanceof Section)) {
    throw new Error('Expected department heading; got: ' + JSON.stringify(section));
  }
