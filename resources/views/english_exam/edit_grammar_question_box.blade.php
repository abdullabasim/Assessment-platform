...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Dashboard
                <small>Edit Question Box </small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">Edit Question Box</li>
            </ol>
        ...
        <section class="content">
            <div class="box box-default">
                ...
                <div id="errorsJs"></div>
                <form id="formId" method="post" action="{{url('editGrammarBoxQuestion')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <!-- /.box-header -->
