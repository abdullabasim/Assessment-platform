...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Dashboard
                <small>Add Personal Question </small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">Add Personal Question</li>
            </ol>
        ...
        <section class="content">
            <div class="box box-default">
                ...
                <div id="errorsJs"></div>
                <form id="formId" method="post" action="{{url('addPersonalQuestion')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <!-- /.box-header -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6  col-md-offset-1">
                                <div class="form-group">
                                    <label>Personal Question Type</label>
                ...
                if(selection == 1)
                {
                   ...
                   $('.item').empty();
                    items.append(
                        ...
                        '                                    <textarea id ="questionBody11" name="personalMultiChoseQuestion" class="form-control" rows="3" placeholder="Enter Question Body" required ></textarea>                                </div>\n' +
                        '\n' +
                        '                            </div>\n' +
                        '\n' +
                        '                        </div>\n' +
